...
//      은행 선택
      ...
      while(true) {
         ...
         while(true) {
            ...
            switch(choice) {
            case 1: //계좌개설
               Tbank[] arBank = {new Shinhan(), new Kookmin(), new Dongseok()};
...
//               } while (password.length() != 4);
               ...
               Tbank.arrBank[bankNumber - 1][Ttbank.arCount[bankNumber - 1]] = arBank[bankNumber - 1];
               Tbank.arCount[bankNumber - 1]++;
            ...
            case 2: //입금하기
               ...
               bank = Tbank.login(account, password);
               
//            	* - 계좌를 개설한 은행에서만 입금 가능★
               if(account.charAt(0) ==  bankNumber ) {
	               if(bank != null) {
               ...
               System.out.println("확인되지 않은 계좌입니다.");
               break;
            ...
            case 5: //계좌번호 찾기
               ...
               bank = Tbank.checkPhoneNumber(phoneNumber);
