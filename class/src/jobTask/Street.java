		...
		while(true) {
			...
			case 1 :		//판매하기
				...
				case -1 :	//실패
					...
					if(seller.count == 3 && seller.positionNumber != 0)	{	//3번 실패시 좌천
						seller.demote();
						System.out.println(seller.table[seller.positionNumber] +"강등되었습니다.");
					}
					break;
				}
				System.out.println("내 통장잔고 : " + seller.income + " 만원");
				break;
			case 2 :		//승진하기
//				2일때는 승진 불가
